...
document.addEventListener('DOMContentLoaded', function() {
    ...
    contactButton.addEventListener('click', function(event) {
        ...
        const body = encodeURIComponent("Dear Avanthikaa,\n\nWe are pleased to extend the following offer to you...");
        this.href = `mailto:avanthikaasrinivasan@gmail.com?subject=${subject}&body=${body}`;
...
const typed = new Typed('.multiple-text', {
    strings: ['Aspiring Data Scientist', 'ML Engineer', 'AI Engineer'],
    typeSpeed: 100,
    backSpeed: 100,
    backDelay: 1000,
    loop: true
